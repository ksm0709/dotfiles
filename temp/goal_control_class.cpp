...
void goal_control::init() {
  ...
  genie_goal =
      nh.subscribe("/robot_cmd", 3, &goal_control::genieGoalCallback, this);
  rviz_goal_sub =
      nh.subscribe("/rviz_goal", 10, &goal_control::rvizGoalCallback, this);
...
void goal_control::rvizGoalCallback(
