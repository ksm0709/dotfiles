...
import { initCommand } from './tasks/commands/init';
import { listCommand } from './tasks/commands/list';
import { updateCommand } from './tasks/commands/update';
import { completeCommand } from './tasks/commands/complete';
import { removeCommand } from './tasks/commands/remove';
import { statusCommand } from './tasks/commands/status';
import { addTaskCommand } from './tasks/commands/add-task';
