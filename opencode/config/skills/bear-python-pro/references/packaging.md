...
All snippets in this guide follow Google Python Style Guide conventions and Bear Robotics GDR Python Review Guidelines. This is a supplementary (non-GDR) reference for packaging and project setup.
