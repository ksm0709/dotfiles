---
name: cpp-pro
description: Use when building C++ applications requiring modern C++17/20/23 features, template metaprogramming, or high-performance systems. Invoke for concepts, ranges, coroutines, SIMD optimization, memory management.
license: MIT
metadata:
  author: https://github.com/Jeffallan
  version: "1.0.0"
  domain: language
  triggers: C++, C++17, C++20, C++23, modern C++, template metaprogramming, systems programming, performance optimization, SIMD, memory management, CMake
  role: specialist
...
1. **Analyze architecture** - Review build system, compiler flags, performance requirements, C++ version
2. **Design with concepts** - Create type-safe interfaces using C++17/20/23 concepts
...
### MUST DO
- Follow C++ Core Guidelines:[google c++ guideline](https://google.github.io/styleguide/cppguide.html)
