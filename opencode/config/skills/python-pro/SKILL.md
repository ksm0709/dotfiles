...
5. **Validate** - Run mypy, formatter, and ruff; ensure Google Python Style Guide compliance
...
- Follow Google Python Style Guide conventions (imports, naming, docstrings, spacing)
...
Python 3.11+, typing module, mypy, pytest, yapf, ruff, dataclasses, async/await, asyncio, pathlib, functools, itertools, Poetry, Pydantic, contextlib, collections.abc, Protocol
